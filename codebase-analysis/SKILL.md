...
This skill provides techniques for extracting business requirements, domain knowledge, and technical specifications from existing codebases, as well as safe strategies for implementing new changes.

## Usage Modes

This skill operates in two distinct modes depending on the user's request:
...
2. **Feature Implementation Mode (Phases 1-6):**
