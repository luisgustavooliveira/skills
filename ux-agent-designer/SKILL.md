...
Use Ant Design System v6 for components e semantic tokens
...
<ConfigProvider
  theme={{
    token: {
      ...
      colorSuccessTextActive: '#166534',
      colorWarningBg: '#fffbeb',
      colorWarningBgHover: '#fef3c7',
      colorWarningBorder: '#fde047',
      colorWarningBorderHover: '#facc15',
      colorWarningHover: '#eab308',
      colorWarningActive: '#ca8a04',
      colorWarningText: '#a16207',
      colorWarningTextHover: '#854d0e',
      colorWarningTextActive: '#713f12',
      colorErrorBg: '#fdf2f8',
      colorErrorBgHover: '#fce7f3',
      colorErrorBorder: '#f9a8d4',
      colorErrorBorderHover: '#f472b6',
      colorErrorHover: '#ec4899',
      colorErrorActive: '#db2777',
      colorErrorText: '#be185d',
      colorErrorTextHover: '#9d174d',
      colorErrorTextActive: '#831843',
      colorInfoBg: '#eff6ff',
